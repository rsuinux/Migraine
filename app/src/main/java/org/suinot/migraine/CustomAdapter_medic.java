...
/**
 * Created by remi on 21/10/16.
 */

public class CustomAdapter_medic extends BaseAdapter{
     ...
     * @param data
     */
    CustomAdapter_medic(Context context, int resource, ArrayList<Item_Medicament> data) {
